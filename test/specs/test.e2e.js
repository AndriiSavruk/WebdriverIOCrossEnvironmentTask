...
import envJson from '../../environments/env.json' assert { type: "json" };

const userName = envJson.USER_NAME;
const userPassword = envJson.USER_PASSWORD;
const userFirstName = envJson.USER_FIRSTNAME;
